...
[Collaborative bug reporting](developer-tools,product) for a product used by 250,000+ users, as an engineer on a small Series A team.

## Experience

- Contributed and stabilized a [full-stack application spanning a browser extension, recording applications, and web dashboard](frontend,developer-tools,product), [billing, external integrations, asynchronous media processing](backend), and a [GraphQL API backed by PostgreSQL](backend,postgres).
